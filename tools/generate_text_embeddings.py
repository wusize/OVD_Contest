...
if __name__ == '__main__':
    ...
    parser.add_argument('--ann', default=r"G:\BaiduNetdiskDownload\json_pre_contest\json_pre_contest\test_eng.json")
    parser.add_argument('--out_path',
                        default=r"G:\BaiduNetdiskDownload\json_pre_contest\json_pre_contest\ovd360_clip_vitl14.npy")

    args = parser.parse_args()

    model, _, _ = open_clip.create_model_and_transforms(
        args.model_version, pretrained='openai', cache_dir=r'F:\projects\open_clip\checkpoints'
    )
    model.cuda()
